<?php
/*
Template Name: Шаблон услуг новый
...
<main class="content">
  ...
  <div class="r_block center_block">
    <div class="r_block__in">
      <div class="r_block__title"><?= $reglamenty['zagolovok']; ?></div>
      <ul class="r_block__list">
        <?php
            if (isset($reglamenty)) {
                foreach ($reglamenty['spisok'] as $item) {
        ?>
        	<li><?= $item['tekst']; ?></li>
        <?php
                }
