...
$(document).ready(function () {
  $(".quiz-open-corp").click(function(e){
      $('.modal-quiz').css('display', 'flex');
...
//close modal
$(document).ready(function () {
    $('.form .close, .close-x').click(function () {
...
$(document).ready(function () {
    ...
    <div class="quiz-navigation">
      <div class="quiz-navigation-prev">
        <bur class="button">назад</span>
      </div>
      <span></span>
      <div class="quiz-navigation-next">
        <span class="button">далее</span>
      </div>
    </div>
            `;

    quiz.children(".quiz-item").append(nav);

    $('.quiz-item input:radio').on('change', function(){
        activate_quiz_item($(this));
    });
    $('.quiz-radio .wpcf7-list-item-label').click(function(){
      $(this).prev().prop('checked', true);
      activate_quiz_item($(this));
    });

    $('.quiz-navigation-prev').click(function(){
      left_position -= 1;
      quiz.children(".quiz-item").css('transform', 'translateX(-'+left_position*100+'%)');
    });
    $('.quiz-navigation-next').click(function(){
      left_position += 1;
      quiz.children(".quiz-item").css('transform', 'translateX(-'+left_position*100+'%)');
    });

    function activate_quiz_item(children){
      let parent = children.parent();
      while(!parent.hasClass('quiz-item')){
    ...
    $('.quiz-open').click(function () {
     ...
     $('.quiz-block .close').click(function () {
        $('.modal-quiz').css('display', 'none');
     });
	
      $('.call-back-open').click(function () {
        $('.modal-quiz--call-back').css('display', 'flex');
      });
      $('.modal-quiz--call-back .close').click(function () {
        $('.modal-quiz--call-back').css('display', 'none');
      });
	
	$('.action-open').click(function () {
        $('.modal-quiz--action').css('display', 'flex');
      });
      $('.modal-quiz--action .close').click(function () {
        $('.modal-quiz--action').css('display', 'none');
      });
	
	$('.portf-open').click(function () {
        $('.modal-quiz--portf').css('display', 'flex');
      });
      $('.modal-quiz--portf .close').click(function () {
        $('.modal-quiz--portf').css('display', 'none');
      });
	$('.modal-quiz--portf input[name="title_service"]').val($('.modal-order input[name="title_service"]').val());
	$('.modal-quiz--action input[name="title_service"]').val($('.modal-order input[name="title_service"]').val());
});
...
$(document).ready(function () {
  ...
  document.addEventListener( 'wpcf7mailsent', function( event ) {
    ym(39642225,'reachGoal','sendForm');
    return false;
  }, false );
});
...
$(function(){
  if (b24Tracker) {
    ...
    var input = '<input type="hidden" name="TRACE">';
    var url = '<input type="hidden" name="i_url" value="'+window.location.href+'">';
...
$(window).on('resize', function() {
  if ($(this).innerWidth() <= 1024) {
  	$('.portfolio--redesign .side-bar--list li').first().addClass('active-tag');
  } else {
  	$('.portfolio--redesign .side-bar--list li').first().removeClass('active-tag');
  }
});

$('.portfolio--redesign .side-bar--list li').click(function() {
	$('.portfolio--redesign .side-bar--list li:not(.active-tag)').slideToggle();
})
